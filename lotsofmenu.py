...
"""
cc = session.query(MenuItem).filter_by(name = "Cachapa")
for c in cc:
       print c.id
       print c.price
...
1. retrieving the values of table restaurant - id and name
...
2. retrieving all the values of menuItem
menu= session.query(MenuItem).first()
for menuu in menu:
       print menuu.id
       print menuu.name
       print menuu.description
       print menuu.price
       print menuu.restaurant.id

3. retrieving the price  of MenuItem whose id is 8
 veggieburger= session.query(MenuItem).filter_by(id=8).first()
 print veggieburger.price

4. using first()
first= session.query(MenuItem).first()
print first.price , first.name, first.restaurant.name, first.course
