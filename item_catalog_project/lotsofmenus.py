""" This is for inserting the values of attributes in database"""
# importing necessary modules
from sqlalchemy import create_engine
from sqlalchemy.orm import sessionmaker
# importing database_setup module
from database_setup import Restaurant, Base, MenuItem, User
engine = create_engine('sqlite:///restaurantmenu.db')
# Bind the engine with Base class so that the
# declaratives can be accessed through a DBSession instance
Base.metadata.bind = engine
# communicates between code executions and engine we created
# alchemy executes DB operations via interface(session)
DBSession = sessionmaker(bind=engine)
# create a instance of DBSession and call it as session
session = DBSession()

# Create dummy user
User1 = User(name="Anum Sharma", email="anumsharma@udacity.com",
             picture='https://pbs.twimg.com/profile_images/2671170543/18debd694829ed78203a5a36dd364160_400x400.png')
session.add(User1)
session.commit()


# Menu for Nordstrom Valley Fair
restaurant1 = Restaurant(user_id=1,
                         name="Nordstrom Valley Fair")
...
# Menu for Dan Izakaya
restaurant2 = Restaurant(user_id=1, name="Dan Izakaya")
...
menuItem4 = MenuItem(user_id=1,
                     name="Fresh Mint Chip ice cream",
